...
<div class="topbar">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
         <a class="navbar-brand pull-left" href="index.html"><img src="images/logoTLP.png" alt="logo" class="logos" /></a>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="about-text">
                        <h2>About Us</h2>
                        <p>{{ $data->about_us }}</p> 
                        <!-- <a href="/about" class="lineBtn">Read More</a> -->
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="about-image">
                        <img src="/assets/landing-2/img/about.jpg" alt="About Images">
                    </div>
                </div>
            </div>
        </div>
